...
var forwardLogger = require('@sex-pomelo/sex-pomelo-logger').getLogger('forward-log', __filename);
/**
 * Handler service.
...
var Service = function(app, opts) {
  ...
  var autoStart = app.get('yz_autoStartHandler');//���� lifecycle::beforeStartup ������ �� yz_autoStartHandler ���������Ƿ�Ҫ�Զ���
  if( autoStart ===true){
