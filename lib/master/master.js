...
const crashLogger = require('@sex-pomelo/sex-pomelo-logger').getLogger('crash-log', __filename);
const adminLogger = require('@sex-pomelo/sex-pomelo-logger').getLogger('admin-log', __filename);
