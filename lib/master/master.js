...
var crashLogger = require('@sex-pomelo/sex-pomelo-logger').getLogger('crash-log', __filename);
var adminLogger = require('@sex-pomelo/sex-pomelo-logger').getLogger('admin-log', __filename);
var admin = require('@sex-pomelo/sex-pomelo-admin');
