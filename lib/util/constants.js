...
let env = (args.env!=='production')? args.env + '/' : '';
...
module.exports = {
  ...
  FILEPATH: {
    MASTER: `/config/${env}master.json`,
    SERVER: `/config/${env}servers.json`,
    CRON: `/config/${env}crons.json`,
    LOG: `/config/${env}log4js.json`,
    SERVER_PROTOS: `/config/${env}serverProtos.json`,
    CLIENT_PROTOS: `/config/${env}clientProtos.json`,
    MASTER_HA: `/config/${env}masterha.json`,
