...
class Application{
  ...
  constructor(){
    ...
    /** @type {ChannelService} The ChannelService 
    */
    this.channelService = null;

    /** @type {BackendSessionService} The BackendSessionService 
    */
   this.backendSessionService = null;

   /** @type {SessionService} The SessionService 
    */
   this.sessionService = null;

   /** @type {string} App run mode 
    */
   this.mode = '';
  ...
  init(opts) {
    ...
    // current server info
    /** @type {string} current server id */
    this.serverId = null;
    /** @type {string} current server type */
    this.serverType = null;
    /** @type {ServerInfo} current server info */
    this.curServer = null;
    /** @type {number}  current server start time, unix timestamp */
    this.startTime = null;
